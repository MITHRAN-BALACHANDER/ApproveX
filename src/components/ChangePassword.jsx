...
const ChangePassword = ({ isOpen, onClose, userToken, userRole }) => {
  ...
  const requestOTP = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/password/request-password-change-otp', {
        method: 'POST',
        headers: {
  ...
  const onSubmitPassword = async (data) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/password/change-password', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${userToken}`,
          'Content-Type': 'application/json'
  ...
  const onSubmitOTP = async (data) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/password/change-password-with-otp', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${userToken}`,
          'Content-Type': 'application/json'
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div className="mt-3">
          ...
          {step === 1 && (
            <div>
              <p className="text-gray-600 mb-4">Choose how you want to verify your identity:</p>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Verify with your current password</p>
                    </div>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Get verification code via email</p>
                    </div>
                  </div>
                </button>
              </div>
          ...
          {step === 3 && (
            <div className="text-center">
              ...
              <h4 className="text-lg font-medium text-gray-900 mb-2">Password Changed Successfully!</h4>
