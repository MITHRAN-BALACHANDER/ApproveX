                ...
                <input
                  {...register('collegeEmail', {
                    ...
                    pattern: {
                      ...
                      message: 'Please enter a valid college email (e.g., mithrans23it@srishakthi.ac.in)'
                    }
                  })}
                  type="email"
    ...
    return (
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmitStep2)}>
            <div className="space-y-4">
              <div>
                ...
                {errors.verificationToken && (
                  <p className="mt-1 text-sm text-red-600">{errors.verificationToken.message}</p>
                )}
              </div>
