...
export const dutyRequestAPI = {
  ...
  updateApproval: (id, approvalData) => api.put(`/duty-requests/${id}/approve`, approvalData),
  
  // Get pending requests for approval (teachers only)
  getPendingApprovals: (level) => api.get(`/duty-requests/pending/approvals?level=${level}`),
