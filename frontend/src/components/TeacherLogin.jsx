...
const TeacherLogin = () => {
  ...
  const onSubmit = async data => {
    ...
    try {
      const response = await fetch(`${config.api.baseUrl}/teacher/login`, {
        method: 'POST',
        headers: {
          ...
          <div className='bg-muted/50 border border-border rounded-lg p-4 mt-6'>
            <div className='flex gap-3'>
              ...
              <div className='text-xs text-muted-foreground space-y-1'>
                ...
                <p>
                  Your account is created by the system administrator. You can use any email address. Contact admin if you don't have credentials.
                </p>
              </div>
            </div>
          </div>
