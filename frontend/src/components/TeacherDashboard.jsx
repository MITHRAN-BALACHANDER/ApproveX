...
const TeacherDashboard = () => {
  ...
  const fetchRequests = async () => {
    try {
      const response = await fetch(`${config.api.baseUrl}/teacher/requests`, {
        headers: {
  ...
  const pendingCount = requests.filter(r =>
    ['pending', 'under_review', 'submitted'].includes(r.overallStatus)
  ).length
                      ...
                      <div className='flex items-start gap-4'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-muted-foreground'>
                            ...
                            {request.studentInfo?.department}
                          </p>
                    ...
                    <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
                      <div className='flex items-start gap-4'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-muted-foreground'>
                            {request.studentId?.profile?.registerNumber} •{' '}
            ...
            <div className='p-6 overflow-y-auto flex-1 space-y-6'>
              ...
              <div className='bg-muted/30 p-4 rounded-2xl border border-border'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                  ...
                  <div>
                    ...
                    <p className='font-medium text-foreground'>
                      {selectedRequest.studentInfo?.year} -{' '}
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
                  ...
                  <div>
                    ...
                    <p className='font-medium text-foreground capitalize'>
                      {selectedRequest.eventDetails?.reasonType}
                    </p>
                  </div>
                  <div>
              ...
              <div className='bg-muted/30 p-4 rounded-2xl border border-border'>
                ...
                <div className='flex gap-4 text-sm'>
                  <div
                    className={`flex items-center gap-2 ${selectedRequest.documents?.invitation ? 'text-green-600' : 'text-destructive'}`}
                  >
                  ...
                  <div
                    className={`flex items-center gap-2 ${selectedRequest.documents?.permissionLetter ? 'text-green-600' : 'text-muted-foreground'}`}
                  >
